...
function M.get(p, opts, fg)
  ...
  return {
    ...
    BlinkCmpKindClass = { fg = p.fg_gutter },
    BlinkCmpKindConstant = { fg = p.red },
    BlinkCmpKindConstructor = { fg = p.fg_gutter },
    BlinkCmpKindEnum = { fg = p.fg_gutter },
    BlinkCmpKindEnumMember = { fg = p.red },
    BlinkCmpKindField = { fg = p.fg_gutter },
    BlinkCmpKindFile = { fg = p.teal },
    BlinkCmpKindFolder = { fg = p.teal },
    BlinkCmpKindFunction = { fg = p.fg_gutter },
    BlinkCmpKindInterface = { fg = p.fg_gutter },
    BlinkCmpKindKeyword = { fg = p.orange },
    BlinkCmpKindMethod = { fg = p.fg_gutter },
    BlinkCmpKindModule = { fg = p.fg_gutter },
    BlinkCmpKindOperator = { fg = fg },
    BlinkCmpKindProperty = { fg = p.fg_gutter },
    BlinkCmpKindReference = { fg = p.teal },
    BlinkCmpKindSnippet = { fg = p.green },
    BlinkCmpKindStruct = { fg = p.fg_gutter },
    BlinkCmpKindText = { fg = fg },
    BlinkCmpKindTypeParameter = { fg = p.fg_gutter },
    BlinkCmpKindUnit = { fg = p.red },
    BlinkCmpKindValue = { fg = p.red },
