...
function M.get(p, opts, fg)
  ...
  return {
    ...
    NeoTreeGitStatusRenamed = { fg = p.teal },
    ...
    BlinkCmpKindColor = { fg = p.orange_light, bg = float_bg },
    ...
    BlinkCmpKindEvent = { fg = p.teal_light, bg = float_bg },
